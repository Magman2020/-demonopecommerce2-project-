...
public class D01_registerStepDef {
    ...
    public void user_push_reg() {
        ...
        Hooks.driver.findElement(By.id("FirstName")).sendKeys("Momo");
        ...
        //insert Email
        Hooks.driver.findElement(By.id("Email")).sendKeys("MOMO@hotmail.com");

        //insert company
        Hooks.driver.findElement(By.id("Company")).sendKeys("Momo");

        //insert pass and confirm pass
        Hooks.driver.findElement(By.id("Password")).sendKeys("MomoCompany");
        Hooks.driver.findElement(By.id("ConfirmPassword")).sendKeys("MomoCompany");
